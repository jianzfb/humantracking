...
model = dict(
    ...
    train_cfg=dict(
        ...
        POSE_RES_MODEL=dict(
            ...
            PRETRAINED_IM= '/workspace/humantracking/base/data/pretrained_model/resnet50-19c8e357.pth',
            PRETRAINED_COCO= '/workspace/humantracking/base/data/pretrained_model/pose_resnet_50_256x192.pth.tar',
            EXTRA=dict(
