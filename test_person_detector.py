...
video_dc['image', 'frame_index']('/workspace/1531_1721197037_raw.mp4'). \
    ...
    inference_onnx_op['resized_image_for_det', 'person_ball_feature_det'](
        mean=(128, 128, 128),
        std=(128, 128, 128),
        onnx_path='/workspace/humantracking/coco-personface-det-t-epoch_175-model.onnx',
    ). \
    ...
    runas_op[('frame_index', 'image', 'obj_bboxes', 'obj_labels'), 'out'](func=det_result_show).run()
