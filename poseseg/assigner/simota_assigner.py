...
from antgo.framework.helper.models.detectors.core import BBOX_ASSIGNERS
from models.utils.typing import ConfigType
...
class SimOTAAssigner2:
    ...
    def __init__(self,
        ...
        self.iou_calculator = BBOX_ASSIGNERS.build(iou_calculator)
        self.oks_calculator = BBOX_ASSIGNERS.build(oks_calculator)
