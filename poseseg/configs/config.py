...
data=dict(
    train=dict(
        type='PersonPoseDataset',
        train_or_test='train',
        dir='/dataset',
        params=dict(
            anno_list=[
                '/dataset/PoseSeg-AHP/poseseg_ahp_train.json',
                '/dataset/PoseSeg-AHP/poseseg_ahp_train.json',
                '/dataset/PoseSeg-AHP/poseseg_ahp_train.json',
                '/dataset/PoseSeg-AHP/poseseg_ahp_train.json',
                '/dataset/PoseSeg-AHP/poseseg_ahp_train.json',
        ...
        pipeline=[
            dict(type="ConvertRandomObjJointsAndOffset", input_size=(256,256), heatmap_size=(64,64), num_joints=33),
