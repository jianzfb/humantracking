...
class UDM(nn.Module):
    def __init__(self, in_channels=1, mid_channels=64, out_channels=64, delta_mode=True, pan_mode=True, deepen_factor=1.0, widen_factor=1.0, out_strides=[16,32]):
        ...
        self.down4_to_16 = nn.Sequential(
            ConvModule(
                mid_channels,
                96,
                kernel_size=3,
        ...
        self.down4_to_32 = nn.Sequential(
            ConvModule(
                mid_channels,
                96,
                kernel_size=3,
        ...
        # appm
        self.appm = APPM(in_channels=160, mid_channels=mid_channels, out_channels=mid_channels)
