...
class PoseSegNet(BaseModule):
    def __init__(self, backbone, head, neck=None, train_cfg=None, test_cfg=None, init_cfg=None):
    ...
    def forward_train(self, image, heatmap, offset_x, offset_y, heatmap_weight, joints_vis, segments, **kwargs):
        ...
        uv_heatmap, uv_off, seg_logits = output
    ...
    def onnx_export(self, image):
        ...
        seg = torch.softmax(seg, 1)
        return heatmap, offset, seg