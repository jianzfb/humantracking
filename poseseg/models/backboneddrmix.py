...
from antgo.framework.helper.cnn.bricks.waterfall import ConvWaterFall
...
class BackboneDDRMIX(nn.Module):
    def __init__(self, architecture='resnet34', in_channels=3):
        super(BackboneDDRMIX, self).__init__()
        ...
        self.layer4_2 = ConvWaterFall(64,16,64)
        self.layer4_3 = ConvWaterFall(64,16,64)
        self.layer4_4 = ConvWaterFall(64,16,64)
