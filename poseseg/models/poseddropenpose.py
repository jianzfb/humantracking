...
class Stage_1(nn.Module):
    def __init__(self):
        ...
        self.conv4_CPM_L1 = ConvModule(
                    ...
                    act_cfg=None, 
                    norm_cfg=dict(type='BN'))
        self.conv5_CPM_L1 = nn.Conv2d(in_channels=128, out_channels=32*2, kernel_size=1, stride=1, padding=0)
        ...
        self.conv4_CPM_L2 = ConvModule(
                    ...
                    act_cfg=None, 
                    norm_cfg=dict(type='BN'))
        self.conv5_CPM_L2 = nn.Conv2d(in_channels=128, out_channels=33, kernel_size=1, stride=1, padding=0)
        self.relu = nn.ReLU()
...
class Stage_x(nn.Module):
    def __init__(self):
        ...
        self.conv4_L1 = ConvModule(
                    ...
                    act_cfg=None, 
                    norm_cfg=dict(type='BN'))        
        self.conv5_L1 = nn.Conv2d(in_channels = 128, out_channels = 32*2, kernel_size = 1, stride = 1, padding = 0)
        ...
        self.conv4_L2 = ConvModule(
                    ...
                    act_cfg=None, 
                    norm_cfg=dict(type='BN')) 
        self.conv5_L2 = nn.Conv2d(in_channels = 128, out_channels = 33, kernel_size = 1, stride = 1, padding = 0)
        self.relu = nn.ReLU()
...
class PoseDDROpenPose(BaseModule):
