...
class LiteResnet(nn.Module):
    def __init__(self, num_classes, in_channels=3):
        super(LiteResnet, self).__init__()
        ...
        self.layer6 = self.make_layer(self.block, 192, self.layers[5], stride=2, dcn=stage_dcn[5])
        self.block.exp = 6
        self.layer7 = self.make_layer(self.block, 192, self.layers[6], stride=1, dcn=stage_dcn[6])
        self.layer8 = self.make_layer(self.block, 384, self.layers[7], stride=2, dcn=stage_dcn[7])
