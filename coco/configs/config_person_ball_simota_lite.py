# 优化器配置
optimizer = dict(type='Adam', lr=0.001,  weight_decay=5e-4)  # 0.01
...
data=dict(
    train=dict(
        ...
        pipeline=[
            ...
            dict(type='KeepRatio', aspect_ratio=2.0),
            dict(type="ResizeS", target_dim=(256, 128)),    # 704, 384
...
# 导出配置
export=dict(
    input_shape_list = [[1,3,128,256]],
    input_name_list=["image"],
    output_name_list=["output1", "output2", "output3"]
)
