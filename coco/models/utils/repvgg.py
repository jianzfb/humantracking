...
class RepVGG(nn.Module):
    ...
    def __init__(self, num_blocks, num_classes=1000, width_multiplier=None, override_groups_map=None):
        ...
        self.stage0 = RepVGGBlock(in_channels=3, out_channels=self.in_planes, stride=2, padding=1, without_branch_norm=False)
    ...
    def _make_stage(self, planes, num_blocks, stride):
        ...
        for stride in strides:
            ...
            blocks.append(RepVGGBlock(in_channels=self.in_planes, out_channels=planes, 
                                      stride=stride, padding=1, groups=cur_groups, without_branch_norm=False))
