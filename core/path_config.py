...
LSPET_ROOT = join('/workspace/Dataset', 'hr-lspet')
...
DATASET_NPZ_PATH = '/workspace/humantracking/base/data/dataset_extras'
...
CUBE_PARTS_FILE = '/workspace/humantracking/base/data/cube_parts.npy'
JOINT_REGRESSOR_TRAIN_EXTRA = '/workspace/humantracking/base/data/J_regressor_extra.npy'
JOINT_REGRESSOR_H36M = '/workspace/humantracking/base/data/J_regressor_h36m.npy'
VERTEX_TEXTURE_FILE = '/workspace/humantracking/base/data/vertex_texture.npy'
STATIC_FITS_DIR = '/workspace/humantracking/base/data/static_fits'
FINAL_FITS_DIR = '/workspace/humantracking/base/data/final_fits'
SMPL_MEAN_PARAMS = '/workspace/humantracking/base/data/smpl_mean_params.npz'
SMPL_MODEL_DIR = '/workspace/humantracking/base/data/smpl'
